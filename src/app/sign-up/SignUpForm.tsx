...
const INPUT_CLASS =
  "w-full bg-surface border border-border px-3 py-2 text-xs text-text-primary placeholder:text-text-muted focus:outline-none focus:border-border-focus transition-colors";
...
export function SignUpForm() {
  ...
  return (
    <form action={action} className="space-y-3">
      {/* Inline error */}
      {state?.error && (
        <div className="px-3 py-2 bg-error/10 border border-error/30" style={INPUT_STYLE}>
